...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(isOwner() == true, "Only owner can access it");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Can't cal this function");
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(!_paused, "it is already paused");
        _;
    }

    modifier whenPaused() {
        require(_paused, "it is already un-paused");
        _;
    }
...
contract ERC165 {
    ...
    function _registerInterface(bytes4 interfaceId) internal {
        require(interfaceId != 0xffffffff, "Wrong interface id");
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0), "You can't call this function");
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner(), "Condition failed");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            msg.sender == owner() || isApprovedForAll(owner(), msg.sender),
            "Condidtion not satisfied"
        );
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "Condition unsatisfied");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "You can't transfer this");
...
contract ERC721Enumerable is ERC165, ERC721 {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index)
        ...
        returns (uint256)
    {
        require(index < balanceOf(owner), "NA");
